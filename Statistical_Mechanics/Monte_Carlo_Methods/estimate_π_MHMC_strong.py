...
def run_plotly(N, epsilon):
    ...
    fig.add_trace(
        go.Scatter(
            x=[a[0]], y=[b[0]], mode="markers", marker=dict(size=20), name="Start"
        )
    )
    ...
    fig.add_annotation(
        ...
        yref="paper",
        text=(
            "Metropolis–Hastings sampling inside the unit disk.<br> "
    ...
    fig.write_html(
        "Monte_Carlo_Methods/web_src/estimate_pi_MHMC_strong.html",
